...
window.addEventListener("resize", () => {
  if (window.innerWidth < 480 || window.matchMedia("only screen and (max-width: 479px)").matches) {
	...
	const mobileCatalogBackground = document.querySelector(".mobile-catalog__background"),
	mobileCatalogModal = document.querySelector(".mobile-catalog__modal");
	mobileCatalogBackground.classList.remove("active");
	mobileCatalogModal.classList.remove("active");
  }
